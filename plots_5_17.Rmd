...
```{r}
plot_age_per_city("Montevideo", "BFD", "N") + goodale_theme() + scale_fill_grey(start = 0.2, end = 0.8)
```
...
```{r}
sig_plot_for_combined_age("Montevideo") + goodale_theme() + scale_fill_grey(start = 0.2, end = 0.8)
```
...
```{r}
plot_seven_function_age("Montevideo") + goodale_theme() + scale_fill_grey(start = 0.2, end = 0.8)
```
...
```{r}
plot_age_per_city("Durazno", "BFD", "N") + goodale_theme() + scale_fill_grey(start = 0.2, end = 0.8)
```
...
```{r}
sig_plot_for_combined_age("Durazno") + goodale_theme() + scale_fill_grey(start = 0.2, end = 0.8)
```
...
```{r}
plot_seven_function_age("Durazno") + goodale_theme() + scale_fill_grey(start = 0.2, end = 0.8)
```
...
```{r} 
make_sig_plot("N", "BFD", long_all) + goodale_theme() + scale_fill_grey(start = 0.2, end = 0.8)
```
